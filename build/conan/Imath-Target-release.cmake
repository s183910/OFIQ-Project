...
########## COMPONENTS TARGET PROPERTIES Release ########################################
    ...
    ########## COMPONENT Imath::Imath #############
        ...
        set_property(TARGET Imath::Imath PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${imath_Imath_Imath_LINKER_FLAGS_RELEASE}> APPEND)
        set_property(TARGET Imath::Imath PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${imath_Imath_Imath_INCLUDE_DIRS_RELEASE}> APPEND)
        set_property(TARGET Imath::Imath PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${imath_Imath_Imath_LIB_DIRS_RELEASE}> APPEND)
        set_property(TARGET Imath::Imath PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${imath_Imath_Imath_COMPILE_DEFINITIONS_RELEASE}> APPEND)
        set_property(TARGET Imath::Imath PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${imath_Imath_Imath_COMPILE_OPTIONS_RELEASE}> APPEND)
    ...
    ########## COMPONENT Imath::ImathConfig #############
        ...
        set_property(TARGET Imath::ImathConfig PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${imath_Imath_ImathConfig_LINKER_FLAGS_RELEASE}> APPEND)
        set_property(TARGET Imath::ImathConfig PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${imath_Imath_ImathConfig_INCLUDE_DIRS_RELEASE}> APPEND)
        set_property(TARGET Imath::ImathConfig PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${imath_Imath_ImathConfig_LIB_DIRS_RELEASE}> APPEND)
        set_property(TARGET Imath::ImathConfig PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${imath_Imath_ImathConfig_COMPILE_DEFINITIONS_RELEASE}> APPEND)
        set_property(TARGET Imath::ImathConfig PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${imath_Imath_ImathConfig_COMPILE_OPTIONS_RELEASE}> APPEND)

    ########## AGGREGATED GLOBAL TARGET WITH THE COMPONENTS #####################
    set_property(TARGET Imath::Imath PROPERTY INTERFACE_LINK_LIBRARIES Imath::Imath APPEND)
    set_property(TARGET Imath::Imath PROPERTY INTERFACE_LINK_LIBRARIES Imath::ImathConfig APPEND)
