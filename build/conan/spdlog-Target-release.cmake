...
########## COMPONENTS TARGET PROPERTIES Release ########################################
    ...
    ########## COMPONENT spdlog::spdlog #############
        ...
        set_property(TARGET spdlog::spdlog PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${spdlog_spdlog_spdlog_LINKER_FLAGS_RELEASE}> APPEND)
        set_property(TARGET spdlog::spdlog PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${spdlog_spdlog_spdlog_INCLUDE_DIRS_RELEASE}> APPEND)
        set_property(TARGET spdlog::spdlog PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${spdlog_spdlog_spdlog_LIB_DIRS_RELEASE}> APPEND)
        set_property(TARGET spdlog::spdlog PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${spdlog_spdlog_spdlog_COMPILE_DEFINITIONS_RELEASE}> APPEND)
        set_property(TARGET spdlog::spdlog PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${spdlog_spdlog_spdlog_COMPILE_OPTIONS_RELEASE}> APPEND)
