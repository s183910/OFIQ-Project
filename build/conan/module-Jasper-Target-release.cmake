...
########## GLOBAL TARGET PROPERTIES Release ########################################
    ...
    set_property(TARGET Jasper::Jasper
                 ...
                 $<$<CONFIG:Release>:${jasper_LINKER_FLAGS_RELEASE}> APPEND)
    set_property(TARGET Jasper::Jasper
                 PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                 $<$<CONFIG:Release>:${jasper_INCLUDE_DIRS_RELEASE}> APPEND)
    # Necessary to find LINK shared libraries in Linux
    set_property(TARGET Jasper::Jasper
                 PROPERTY INTERFACE_LINK_DIRECTORIES
                 $<$<CONFIG:Release>:${jasper_LIB_DIRS_RELEASE}> APPEND)
    set_property(TARGET Jasper::Jasper
                 PROPERTY INTERFACE_COMPILE_DEFINITIONS
                 $<$<CONFIG:Release>:${jasper_COMPILE_DEFINITIONS_RELEASE}> APPEND)
    set_property(TARGET Jasper::Jasper
                 PROPERTY INTERFACE_COMPILE_OPTIONS
                 $<$<CONFIG:Release>:${jasper_COMPILE_OPTIONS_RELEASE}> APPEND)
