...
########## COMPONENTS TARGET PROPERTIES Release ########################################
    ...
    ########## COMPONENT OpenEXR::OpenEXRUtil #############
        ...
        set_property(TARGET OpenEXR::OpenEXRUtil PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${openexr_OpenEXR_OpenEXRUtil_LINKER_FLAGS_RELEASE}> APPEND)
        set_property(TARGET OpenEXR::OpenEXRUtil PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${openexr_OpenEXR_OpenEXRUtil_INCLUDE_DIRS_RELEASE}> APPEND)
        set_property(TARGET OpenEXR::OpenEXRUtil PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${openexr_OpenEXR_OpenEXRUtil_LIB_DIRS_RELEASE}> APPEND)
        set_property(TARGET OpenEXR::OpenEXRUtil PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${openexr_OpenEXR_OpenEXRUtil_COMPILE_DEFINITIONS_RELEASE}> APPEND)
        set_property(TARGET OpenEXR::OpenEXRUtil PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${openexr_OpenEXR_OpenEXRUtil_COMPILE_OPTIONS_RELEASE}> APPEND)
    ...
    ########## COMPONENT OpenEXR::OpenEXR #############
        ...
        set_property(TARGET OpenEXR::OpenEXR PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${openexr_OpenEXR_OpenEXR_LINKER_FLAGS_RELEASE}> APPEND)
        set_property(TARGET OpenEXR::OpenEXR PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${openexr_OpenEXR_OpenEXR_INCLUDE_DIRS_RELEASE}> APPEND)
        set_property(TARGET OpenEXR::OpenEXR PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${openexr_OpenEXR_OpenEXR_LIB_DIRS_RELEASE}> APPEND)
        set_property(TARGET OpenEXR::OpenEXR PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${openexr_OpenEXR_OpenEXR_COMPILE_DEFINITIONS_RELEASE}> APPEND)
        set_property(TARGET OpenEXR::OpenEXR PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${openexr_OpenEXR_OpenEXR_COMPILE_OPTIONS_RELEASE}> APPEND)
    ...
    ########## COMPONENT OpenEXR::OpenEXRCore #############
        ...
        set_property(TARGET OpenEXR::OpenEXRCore PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${openexr_OpenEXR_OpenEXRCore_LINKER_FLAGS_RELEASE}> APPEND)
        set_property(TARGET OpenEXR::OpenEXRCore PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${openexr_OpenEXR_OpenEXRCore_INCLUDE_DIRS_RELEASE}> APPEND)
        set_property(TARGET OpenEXR::OpenEXRCore PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${openexr_OpenEXR_OpenEXRCore_LIB_DIRS_RELEASE}> APPEND)
        set_property(TARGET OpenEXR::OpenEXRCore PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${openexr_OpenEXR_OpenEXRCore_COMPILE_DEFINITIONS_RELEASE}> APPEND)
        set_property(TARGET OpenEXR::OpenEXRCore PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${openexr_OpenEXR_OpenEXRCore_COMPILE_OPTIONS_RELEASE}> APPEND)
    ...
    ########## COMPONENT OpenEXR::IlmThread #############
        ...
        set_property(TARGET OpenEXR::IlmThread PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${openexr_OpenEXR_IlmThread_LINKER_FLAGS_RELEASE}> APPEND)
        set_property(TARGET OpenEXR::IlmThread PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${openexr_OpenEXR_IlmThread_INCLUDE_DIRS_RELEASE}> APPEND)
        set_property(TARGET OpenEXR::IlmThread PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${openexr_OpenEXR_IlmThread_LIB_DIRS_RELEASE}> APPEND)
        set_property(TARGET OpenEXR::IlmThread PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${openexr_OpenEXR_IlmThread_COMPILE_DEFINITIONS_RELEASE}> APPEND)
        set_property(TARGET OpenEXR::IlmThread PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${openexr_OpenEXR_IlmThread_COMPILE_OPTIONS_RELEASE}> APPEND)
    ...
    ########## COMPONENT OpenEXR::Iex #############
        ...
        set_property(TARGET OpenEXR::Iex PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${openexr_OpenEXR_Iex_LINKER_FLAGS_RELEASE}> APPEND)
        set_property(TARGET OpenEXR::Iex PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${openexr_OpenEXR_Iex_INCLUDE_DIRS_RELEASE}> APPEND)
        set_property(TARGET OpenEXR::Iex PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${openexr_OpenEXR_Iex_LIB_DIRS_RELEASE}> APPEND)
        set_property(TARGET OpenEXR::Iex PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${openexr_OpenEXR_Iex_COMPILE_DEFINITIONS_RELEASE}> APPEND)
        set_property(TARGET OpenEXR::Iex PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${openexr_OpenEXR_Iex_COMPILE_OPTIONS_RELEASE}> APPEND)
    ...
    ########## COMPONENT OpenEXR::IlmThreadConfig #############
        ...
        set_property(TARGET OpenEXR::IlmThreadConfig PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${openexr_OpenEXR_IlmThreadConfig_LINKER_FLAGS_RELEASE}> APPEND)
        set_property(TARGET OpenEXR::IlmThreadConfig PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${openexr_OpenEXR_IlmThreadConfig_INCLUDE_DIRS_RELEASE}> APPEND)
        set_property(TARGET OpenEXR::IlmThreadConfig PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${openexr_OpenEXR_IlmThreadConfig_LIB_DIRS_RELEASE}> APPEND)
        set_property(TARGET OpenEXR::IlmThreadConfig PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${openexr_OpenEXR_IlmThreadConfig_COMPILE_DEFINITIONS_RELEASE}> APPEND)
        set_property(TARGET OpenEXR::IlmThreadConfig PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${openexr_OpenEXR_IlmThreadConfig_COMPILE_OPTIONS_RELEASE}> APPEND)
    ...
    ########## COMPONENT OpenEXR::IexConfig #############
        ...
        set_property(TARGET OpenEXR::IexConfig PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${openexr_OpenEXR_IexConfig_LINKER_FLAGS_RELEASE}> APPEND)
        set_property(TARGET OpenEXR::IexConfig PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${openexr_OpenEXR_IexConfig_INCLUDE_DIRS_RELEASE}> APPEND)
        set_property(TARGET OpenEXR::IexConfig PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${openexr_OpenEXR_IexConfig_LIB_DIRS_RELEASE}> APPEND)
        set_property(TARGET OpenEXR::IexConfig PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${openexr_OpenEXR_IexConfig_COMPILE_DEFINITIONS_RELEASE}> APPEND)
        set_property(TARGET OpenEXR::IexConfig PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${openexr_OpenEXR_IexConfig_COMPILE_OPTIONS_RELEASE}> APPEND)
    ...
    ########## COMPONENT OpenEXR::OpenEXRConfig #############
        ...
        set_property(TARGET OpenEXR::OpenEXRConfig PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${openexr_OpenEXR_OpenEXRConfig_LINKER_FLAGS_RELEASE}> APPEND)
        set_property(TARGET OpenEXR::OpenEXRConfig PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${openexr_OpenEXR_OpenEXRConfig_INCLUDE_DIRS_RELEASE}> APPEND)
        set_property(TARGET OpenEXR::OpenEXRConfig PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${openexr_OpenEXR_OpenEXRConfig_LIB_DIRS_RELEASE}> APPEND)
        set_property(TARGET OpenEXR::OpenEXRConfig PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${openexr_OpenEXR_OpenEXRConfig_COMPILE_DEFINITIONS_RELEASE}> APPEND)
        set_property(TARGET OpenEXR::OpenEXRConfig PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${openexr_OpenEXR_OpenEXRConfig_COMPILE_OPTIONS_RELEASE}> APPEND)

    ########## AGGREGATED GLOBAL TARGET WITH THE COMPONENTS #####################
    set_property(TARGET openexr::openexr PROPERTY INTERFACE_LINK_LIBRARIES OpenEXR::OpenEXRUtil APPEND)
    set_property(TARGET openexr::openexr PROPERTY INTERFACE_LINK_LIBRARIES OpenEXR::OpenEXR APPEND)
    set_property(TARGET openexr::openexr PROPERTY INTERFACE_LINK_LIBRARIES OpenEXR::OpenEXRCore APPEND)
    set_property(TARGET openexr::openexr PROPERTY INTERFACE_LINK_LIBRARIES OpenEXR::IlmThread APPEND)
    set_property(TARGET openexr::openexr PROPERTY INTERFACE_LINK_LIBRARIES OpenEXR::Iex APPEND)
    set_property(TARGET openexr::openexr PROPERTY INTERFACE_LINK_LIBRARIES OpenEXR::IlmThreadConfig APPEND)
    set_property(TARGET openexr::openexr PROPERTY INTERFACE_LINK_LIBRARIES OpenEXR::IexConfig APPEND)
    set_property(TARGET openexr::openexr PROPERTY INTERFACE_LINK_LIBRARIES OpenEXR::OpenEXRConfig APPEND)
