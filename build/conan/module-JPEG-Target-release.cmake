...
########## GLOBAL TARGET PROPERTIES Release ########################################
    ...
    set_property(TARGET JPEG::JPEG
                 ...
                 $<$<CONFIG:Release>:${libjpeg_LINKER_FLAGS_RELEASE}> APPEND)
    set_property(TARGET JPEG::JPEG
                 PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                 $<$<CONFIG:Release>:${libjpeg_INCLUDE_DIRS_RELEASE}> APPEND)
    # Necessary to find LINK shared libraries in Linux
    set_property(TARGET JPEG::JPEG
                 PROPERTY INTERFACE_LINK_DIRECTORIES
                 $<$<CONFIG:Release>:${libjpeg_LIB_DIRS_RELEASE}> APPEND)
    set_property(TARGET JPEG::JPEG
                 PROPERTY INTERFACE_COMPILE_DEFINITIONS
                 $<$<CONFIG:Release>:${libjpeg_COMPILE_DEFINITIONS_RELEASE}> APPEND)
    set_property(TARGET JPEG::JPEG
                 PROPERTY INTERFACE_COMPILE_OPTIONS
                 $<$<CONFIG:Release>:${libjpeg_COMPILE_OPTIONS_RELEASE}> APPEND)
