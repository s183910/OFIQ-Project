...
########## GLOBAL TARGET PROPERTIES Release ########################################
    ...
    set_property(TARGET quirc::quirc
                 ...
                 $<$<CONFIG:Release>:${quirc_LINKER_FLAGS_RELEASE}> APPEND)
    set_property(TARGET quirc::quirc
                 PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                 $<$<CONFIG:Release>:${quirc_INCLUDE_DIRS_RELEASE}> APPEND)
    # Necessary to find LINK shared libraries in Linux
    set_property(TARGET quirc::quirc
                 PROPERTY INTERFACE_LINK_DIRECTORIES
                 $<$<CONFIG:Release>:${quirc_LIB_DIRS_RELEASE}> APPEND)
    set_property(TARGET quirc::quirc
                 PROPERTY INTERFACE_COMPILE_DEFINITIONS
                 $<$<CONFIG:Release>:${quirc_COMPILE_DEFINITIONS_RELEASE}> APPEND)
    set_property(TARGET quirc::quirc
                 PROPERTY INTERFACE_COMPILE_OPTIONS
                 $<$<CONFIG:Release>:${quirc_COMPILE_OPTIONS_RELEASE}> APPEND)
