...
########## GLOBAL TARGET PROPERTIES Release ########################################
    ...
    set_property(TARGET ade
                 ...
                 $<$<CONFIG:Release>:${ade_LINKER_FLAGS_RELEASE}> APPEND)
    set_property(TARGET ade
                 PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                 $<$<CONFIG:Release>:${ade_INCLUDE_DIRS_RELEASE}> APPEND)
    # Necessary to find LINK shared libraries in Linux
    set_property(TARGET ade
                 PROPERTY INTERFACE_LINK_DIRECTORIES
                 $<$<CONFIG:Release>:${ade_LIB_DIRS_RELEASE}> APPEND)
    set_property(TARGET ade
                 PROPERTY INTERFACE_COMPILE_DEFINITIONS
                 $<$<CONFIG:Release>:${ade_COMPILE_DEFINITIONS_RELEASE}> APPEND)
    set_property(TARGET ade
                 PROPERTY INTERFACE_COMPILE_OPTIONS
                 $<$<CONFIG:Release>:${ade_COMPILE_OPTIONS_RELEASE}> APPEND)
